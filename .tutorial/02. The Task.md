...
Someone has submitted a bug report on this web page. Although, the output of the page looks correct there are two errors. The errors are to do with paragraph tags.
